...
#define Z80_SD_H
    ...
    class Z80SDCard  {
        ...
        public:        
            enum sdResult: uint8_t { ok, nocard, not_idle, invalid_status, not_ready, invalid_capacity, read_timeout, write_error, write_timeout_1, write_timeout_2 }; 
        ...
        private:
            ...
            Z80SPI z80spi; 
            uint8_t sdCmdTxBuffer[SD_COMMAND_BUFFER_LENGTH];
