...
;	TeachZ80 BIOS 
;
;	Minor changes versus original code from John, to run to TeachZ80 boards
;	https://github.com/Z80-Retro/2063-Z80-cpm/blob/main/retro/retro.asm
;
;	Adjusted by Christian Luethi
;	January 2024
;
;****************************************************************************
;
...
.bios_boot:
	...
	ld		a,gpio_out_sd_mosi|gpio_out_sd_clk|gpio_out_sd_ssel|(.low_bank<<4)
	ld		(gpio_out_cache),a
	out		(gpio_out),a
	...
	; Note: console should still be initialized from the boot loader
	;		call .init_console
