...
;   - Jump to the O/S
;
;	Communication: Boot is initializing SIO A (Console) with /64 clock divider.
...
;
;	LED Status: Boot uses the red disk led to display the process status:
...
; START FROM FLASH
;############################################################################## 
boot: 		org  0x0000						; Z80 cold boot vector
